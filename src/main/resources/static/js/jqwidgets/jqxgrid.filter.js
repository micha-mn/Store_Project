...
(function(a) {
	a.extend(a.jqx._jqxGrid.prototype, {
		...
		_renderfilter: function() {
			var f = this;
			var g = a("<div style='display: flex; height: calc(100% - 10px); margin-top: 5px; align-items: center; position: relative; margin-left: 4px;'><input style='width: 200px; height: 100%; direction: ltr;' role='textbox' type='text'/><div style='cursor: pointer; height: 100%;'><div></div></div></div>");
			var m = g.find("input");
			var e = g.find("div:first");
			g.addClass(this.toThemeProperty("jqx-rc-all"));
			g.addClass(this.toThemeProperty("jqx-widget"));
			g.addClass(this.toThemeProperty("jqx-input-group"));
			...
			e.find("div").addClass(this.toThemeProperty("jqx-icon-search"));
			if (this.rtl) {
